...
// ══════════════════════════════════════════════════ 7. Cómo funciona
{
  ...
  const pasos = [
    ...
    ['Claude elige', 'Entre las veintidós herramientas disponibles, selecciona las que corresponden. Una consulta puede combinar varias: ubicar la norma, leer su texto, traer los fallos y sumar el criterio administrativo.'],
